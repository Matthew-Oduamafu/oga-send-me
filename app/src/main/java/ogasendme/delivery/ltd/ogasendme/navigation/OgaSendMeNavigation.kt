...
import ogasendme.delivery.ltd.ogasendme.screens.anything.AnythingScreen
import ogasendme.delivery.ltd.ogasendme.screens.cart.CartScreen
import ogasendme.delivery.ltd.ogasendme.screens.checkout.CheckOutAndNumberScreen
import ogasendme.delivery.ltd.ogasendme.screens.drop_off.DropOffOptionsScreen
import ogasendme.delivery.ltd.ogasendme.screens.electronics.ElectronicsScreen
import ogasendme.delivery.ltd.ogasendme.screens.fashion.FashionScreen
...
import ogasendme.delivery.ltd.ogasendme.screens.welcome.WelcomeScreen
...
fun OgaSendMeNavigation() {
    ...
    AnimatedNavHost(navController = navController, startDestination = Screens.SplashScreen.route,
        ...
        composable(Screens.OTPCodeScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
        ...
        // navigate to Fashion screen
        composable(Screens.FashionScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
        ...
        composable(Screens.ElectronicsScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
        ...
        // navigate to health & Beauty screen
        composable(Screens.HealthAndBeautyScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
            ...
            HealthAndBeautyScreen(navController = navController)
        }


        // navigate to Anything screen
        composable(Screens.AnythingScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
            ...
            AnythingScreen(navController = navController)
        }


        // navigate to package delivery screen
        composable(Screens.PackageDeliveryScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
            ...
            PackageDeliveryScreen(navController = navController)
        }
        ...
        composable(Screens.CheckOutAndNumberScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
            ...
            CheckOutAndNumberScreen(navController = navController)
        }


        // navigate to Check out screen
        composable(Screens.DropOffOptionsScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
            ...
            DropOffOptionsScreen(navController = navController)
        }
        ...
        composable(Screens.UserInformationScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
        ...
        // navigate to shop or store screen
        composable(Screens.StoreOrShopScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
            ...
            StoreOrShopScreen(navController = navController)
        }


        // navigate to selected product screen
        composable(Screens.FoodOrProductItemScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
            ...
            FoodOrProductItemScreen(navController = navController)
        }


        // navigate to selected product details screen
        composable(Screens.SelectedProductDetailsScreen.route,
            enterTransition = {
                slideInHorizontally(
                    initialOffsetX = { 300 },
                    animationSpec = tween(300)
